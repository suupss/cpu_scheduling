...
class SJFTableClass extends StatefulWidget {
  int index;
  bool isOn;
  SJFTableClass(this.index, this.isOn);
  @override
  State<SJFTableClass> createState() => _SJFTableClassState();
}

class _SJFTableClassState extends State<SJFTableClass> {
  int atValue = 0;
  int cpuBurstValue = 0;
  int ioTime = 0;
  int cpu = 0;
