...
class SRTFPageViewForthPage extends StatefulWidget {
  int pageNumber = 0;
  SRTFPageViewForthPage(this.pageNumber);

  @override
  State<SRTFPageViewForthPage> createState() => _SRTFPageViewForthPageState();
}

class _SRTFPageViewForthPageState extends State<SRTFPageViewForthPage> {
              ...
              children: [
                ...
                ElevatedButton(
                  ...
                  style: TextButton.styleFrom(
                      ...
                      backgroundColor:
                          runPhase == 1 ? Vx.gray400 : ColorModel().yellow),
                  child: Text(
