...
class SJFPageViewForthPage extends StatefulWidget {
  int pageNumber = 0;
  SJFPageViewForthPage(this.pageNumber);

  @override
  State<SJFPageViewForthPage> createState() => _SJFPageViewForthPageState();
}

List endItemTime = [];

class _SJFPageViewForthPageState extends State<SJFPageViewForthPage> {
              ...
              children: [
                ...
                ElevatedButton(
                  ...
                  style: TextButton.styleFrom(
                      ...
                      backgroundColor:
                          runPhase == 1 ? Vx.gray400 : ColorModel().blue),
                  child: Text(
